<div class="col-xs-10 col-xs-offset-1">
    <div class='row'>
        <div class='col-xs-12'>
            ...
            <table id="blogDT" class="display dataTable" cellspacing="0" width="100%">
            <thead>
            <tr>
                <th>Category Name</th>
...
<script>
    ...
    var blogDT;
    var actionUrl = "<?php echo base_url(); ?>post/blog";
    ...
    function setupDataTables() {
        ...
        blogDT = $('#blogDT').dataTable({
            ...
            "fnDrawCallback": function( oSettings ) {
                var table = $("#blogDT").dataTable();
                $('#blogDT tbody tr').on('dblclick', function () {
    ...
    function activateEvents() {
        ...
        $('#showBtn').off("click").click(function() {
            update = false;
            $("#globalFormModalPost").find(".modal-title").html("Post Blog Generate Form");
        ...
        $('#deleteBtn').off("click").click(function() {
            selectedRows = $.map($("#blogDT").DataTable().rows('.selected').data(), function (item) {
                return item.post_id;
            });
    ...
    function showAddEditModal(data) {
        update = true;
        $("#globalFormModalPost").find(".modal-title").html("Edit Generated Blog Post");
        $("#globalFormModalPost").modal({
            show: true,
            keyboard: false,
            backdrop: "static"
