<div class="col-xs-10 col-xs-offset-1">
    <div class='row'>
        <div class='col-xs-12'>
            ...
            <h4><i class="fa fa-share"></i> Generic Post Property <small>[ <?php echo $selectedModule; ?> ]</small></h4>
            <hr/>
...
<script>
    ...
    var dt;
    var actionUrl = "<?php echo base_url(); ?>generic_post/facebook";
    ...
    function activateEvents() {
        ...
        $('#showBtn').off("click").click(function() {
            update = false;
            $("#globalFormModalPost").find(".modal-title").html("Post Generic Facebook Generate Form");
    ...
    function showAddEditModal(data) {
        update = true;
        $("#globalFormModalPost").find(".modal-title").html("Edit Generated Generic Facebook Post");
        $("#globalFormModalPost").modal({
            show: true,
            keyboard: false,
            backdrop: "static"
