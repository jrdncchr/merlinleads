...
<script>
    ...
    var dt;
    var actionUrl = "<?php echo base_url(); ?>generic_post/blog";
    ...
    function activateEvents() {
        ...
        $('#showBtn').off("click").click(function() {
            update = false;
            $("#globalFormModalPost").find(".modal-title").html("Post Generic Blog Generate Form");
    ...
    function showAddEditModal(data) {
        update = true;
        $("#globalFormModalPost").find(".modal-title").html("Edit Generated Generic Blog Post");
        $("#globalFormModalPost").modal({
            show: true,
            keyboard: false,
            backdrop: "static"
