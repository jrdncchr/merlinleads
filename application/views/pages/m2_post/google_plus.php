...
var dt;
var actionUrl = "<?php echo base_url(); ?>post/google_plus";
...
function activateEvents() {
    ...
    $('#showBtn').off("click").click(function() {
        update = false;
        $("#globalFormModalPost").find(".modal-title").html("Post Google Plus Generate Form");
...
function showAddEditModal(data) {
    update = true;
    $("#globalFormModalPost").find(".modal-title").html("Edit Generated Google Plus Post");
    $("#globalFormModalPost").modal({
        show: true,
        keyboard: false,
        backdrop: "static"
