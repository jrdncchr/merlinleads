<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url() . "pages/login"; ?>">Merlin Leads &raquo;</a>
        </div>
...
<!--                <li><a target="_blank" href="http://support.merlinleads.com/faqs/">FAQ's</a></li>-->
            ...
            <ul class="nav navbar-nav navbar-right navbar-user" style="margin-right: 5px;">
                <li id="signupNav"><a href="<?php echo base_url() . 'registration'; ?>"><i class="fa fa-user"></i> Sign up</a></li>
                <li><a href='<?php echo base_url() . "pages/login"; ?>'><i class='fa fa-lock'></i> Login</a></li>
            </ul>
        </div>
    </div>
</div>  