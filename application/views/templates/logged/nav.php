<div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="padding-right: 20px;">
    ...
    <div class="collapse navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right navbar-user">
            <?php if($subscription->status == "trialing") { ?>
                <li>
                    <a href="<?php echo base_url() . 'main/myaccount' ?>">
                        <span class="subscription-nav">Trial ends on: <?php echo date("F d, Y", $subscription->trial_end); ?></span>
                    </a>
                </li>
            <?php } ?>
